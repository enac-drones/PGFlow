...
class BuildingsPlotter:
    def __init__(self, building_data:dict, edge_color="black", fill_color="darkgray"):
        self.buildings = [BuildingEntity([tuple(v[:2]) for v in bld['vertices']]) for bld in building_data]
    ...
    def plot(self, ax:Axes):
        for building in self.buildings:
            building_patch = BuildingPatch(building, edgecolor=self.edge_color, facecolor=self.fill_color)
