...
def calculate_field_vectors(coords: ArrayLike, case: Case) -> ArrayLike:
    ...
    for idx, coord in enumerate(coords):
        ...
        vehicle.update_personal_vehicle_dict(
            case.vehicle_list, case.max_avoidance_distance
        )
...
if __name__ == "__main__":
    ...
    # Example usage
    case.vehicle_list[0], case.vehicle_list[3] = (
        case.vehicle_list[3],
        case.vehicle_list[0],
    )
    # buildings = case.buildings
    buildings = [
        building.vertices[..., :2] for building in case.buildings
    ]  # Define buildings as tuples of vertices
